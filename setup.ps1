...
Write-Host "  2. bash scripts/install-plugins.sh         # 自动安装插件（全装+按状态启用）"
Write-Host "  3. bash scripts/install-git-skills.sh      # clone git 来源的 skills"
Write-Host "  4. bash scripts/install-fonts.sh           # 安装 Maple Mono NF CN 字体"
